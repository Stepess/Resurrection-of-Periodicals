insert into user (username, password, email, first_name, last_name, registration_date) values
('senpai', md5('qwerty13'), 'stepanersh@gmail.com',  'Stepan',  'Yershov', 2018-09-13),
